Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/DJDeth/UICheckbox.Swift'
  s.screenshots      = 'https://raw.githubusercontent.com/DJDeth/UICheckbox.Swift/master/Resources/uicheckbox_example.png'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'marcin.polak' => 'mpolak87@gmail.com' }
  s.source           = { :git => 'https://github.com/DJDeth/UICheckbox.Swift.git', :tag => s.version.to_s }
